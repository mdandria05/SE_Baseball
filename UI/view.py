...
class View:
    ...
    def load_interface(self):
        ...
        # TODO
        # Riga 1
        self.dd_anno = ft.Dropdown(label="Anno", width=200, alignment=ft.alignment.top_left, options=self.controller.update_dd_anni(), on_change=self.controller.update_lista1)
